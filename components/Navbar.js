      ...
      >
        ...
        >
          ...
          >
            ...
            <path
              d="M28 20 H40 V45 L65 20 H80 L52 50 L80 80 H65 L40 55 V80 H28 Z"
              fill="url(#logo-grad)"
            />
            <circle
              cx="50"
        ...
        >
          {/* Light/Dark Toggle Switch - Only render after hydration */}
          {mounted && (
            <button
        ...
        >
          ...
          <a
            ...
            style={{
              ...
              padding: "16px 36px",
              background:
                "linear-gradient(135deg, var(--accent) 0%, #7f00ff 100%)",
              color: "#ffffff",
              fontFamily: "var(--font-display)",
              fontWeight: 700,
              fontSize: "15px",
